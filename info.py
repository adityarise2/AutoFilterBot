...
BOT_TOKEN = environ.get('BOT_TOKEN', '5452406096:AAHuMM98LmRKfa1roT67ChmbyOOgAXpzJgM')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '5397893493 1489446496').split()]
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001543052371 -1001941735016 -1001850024466').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://aaditya3993:9lhqbm47wLYJvgly@cluster0.calmxsx.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Files')

# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/ajbackupp')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/ajbackupp')
...
SHORTLINK_API = environ.get("SHORTLINK_API", "07fdfb5b3c17dae8b55adf6c86cc7ee29c1fbecf")
